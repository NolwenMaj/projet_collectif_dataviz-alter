...
function asynchrone(){
  ...
  function generate_table() {
    ...
    /* row.href = document.createTextNode(link.link(link)); */
...
/* -------OLD STUFF */
 ...
 /* case 74 :
      symbole.src="/Jokes/mm_api_symbols/wsymbol_0074_dust_sand_night.png" 
      break; */
      /*  case 56 :
      symbole.src="/Jokes/mm_api_symbols/wsymbol_0056_dust_sand.png" 
      break; */
...
/*     fetch(urlMeme)
        ...
        .then(function (value) { 
            ...
            let imageMeme = document.createElement("img"); 
                ...
                console.log(value.data.memes[n].width) ;
                console.log(value.data.memes[n].height) ;
                imageMeme.width = "300" 
        let divJoke = document.getElementById("meme");
        divJoke.innerHTML = "";
        divJoke.appendChild(imageMeme);
